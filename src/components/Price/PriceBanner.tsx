...
const PriceBanner = ({ conf, children }: { conf: Pricing, children?: ReactNode }) => {
    return (
        <>
            {/* <!-- ===== Pricing Table Start ===== --> */}
            <div className="animate_top group relative rounded-lg border border-stroke bg-white p-7.5 shadow-solid-10 dark:border-strokedark dark:bg-blacksection dark:shadow-none md:w-full lg:w-1/3">
