...
var WhiteStars = () => {
  return /* @__PURE__ */ React2.createElement("svg", { className: "w-4 h-4 text-gray-300 dark:text-gray-500", "aria-hidden": "true", xmlns: "http://www.w3.org/2000/svg", fill: "currentColor", viewBox: "0 0 22 20" }, /* @__PURE__ */ React2.createElement("path", { d: "M20.924 7.625a1.523 1.523 0 0 0-1.238-1.044l-5.051-.734-2.259-4.577a1.534 1.534 0 0 0-2.752 0L7.365 5.847l-5.051.734A1.535 1.535 0 0 0 1.463 9.2l3.656 3.563-.863 5.031a1.532 1.532 0 0 0 2.226 1.616L11 17.033l4.518 2.375a1.534 1.534 0 0 0 2.226-1.617l-.863-5.03L20.537 9.2a1.523 1.523 0 0 0 .387-1.575Z" }));
};
...
var YellowStars = () => {
  return /* @__PURE__ */ React3.createElement("svg", { className: "w-4 h-4 text-yellow-300", "aria-hidden": "true", xmlns: "http://www.w3.org/2000/svg", fill: "currentColor", viewBox: "0 0 22 20" }, /* @__PURE__ */ React3.createElement("path", { d: "M20.924 7.625a1.523 1.523 0 0 0-1.238-1.044l-5.051-.734-2.259-4.577a1.534 1.534 0 0 0-2.752 0L7.365 5.847l-5.051.734A1.535 1.535 0 0 0 1.463 9.2l3.656 3.563-.863 5.031a1.532 1.532 0 0 0 2.226 1.616L11 17.033l4.518 2.375a1.534 1.534 0 0 0 2.226-1.617l-.863-5.03L20.537 9.2a1.523 1.523 0 0 0 .387-1.575Z" }));
};
...
var UserRating = ({ className, rating, children }) => {
  const getYellowStars = (stars) => {
    ...
    let yStars = [];
    while (count < stars) {
      yStars.push(/* @__PURE__ */ React4.createElement(YellowStar_default, { key: count }));
      count++;
    }
    return yStars;
  };
  const getWhiteStars = (stars) => {
    ...
    for (let i = 0; i < count; i++) {
      wStars.push(/* @__PURE__ */ React4.createElement(WhiteStar_default, { key: count }));
    }
    return wStars;
  };
  return /* @__PURE__ */ React4.createElement(React4.Fragment, null, /* @__PURE__ */ React4.createElement("div", { className: cn("animate_top group relative rounded-lg border border-stroke bg-white mt-10 p-7.5 shadow-solid-10 dark:border-strokedark dark:bg-blacksection dark:shadow-none w-full", className) }, /* @__PURE__ */ React4.createElement("article", null, /* @__PURE__ */ React4.createElement("div", { className: "flex items-center mb-4" }, /* @__PURE__ */ React4.createElement("div", { className: "font-medium dark:text-white" }, /* @__PURE__ */ React4.createElement("p", null, rating.user, /* @__PURE__ */ React4.createElement("time", { className: "block text-sm text-gray-500 dark:text-gray-400" }, rating.date)))), /* @__PURE__ */ React4.createElement("div", { className: "flex items-center mb-1 space-x-1 rtl:space-x-reverse" }, getYellowStars(rating.stars), getWhiteStars(rating.stars)), /* @__PURE__ */ React4.createElement("h3", { className: "py-4 text-sm font-semibold text-gray-900 dark:text-white" }, rating.title), /* @__PURE__ */ React4.createElement("p", { className: "mb-2 text-gray-500 dark:text-gray-400" }, rating.comment), /* @__PURE__ */ React4.createElement("aside", null, /* @__PURE__ */ React4.createElement("div", { className: "flex items-center mt-3" }, children)))));
};
...
var ShowCode = ({ className, descriptionNode, code, language }) => {
  ...
  const [descConf, setDescription] = useState2({ visibility: "block", selected: true, style: cssActive });
  const [codeConf, setCode] = useState2({ visibility: "hidden", selected: false, style: cssInactive });
  const [copy, setCopyCommand] = useState2("");
  const [transformedCode, setTransformedCode] = useState2("");
  useEffect(() => {
